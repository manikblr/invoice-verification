            ...
            <div className="flex items-center">
              ...
              <div className="ml-3">
                <p className="text-sm text-blue-700">
                  <strong>Validation Complete!</strong> Review the results below to see how each agent processed your invoice items.
                  Click on "Timeline" view to see the execution order and detailed agent information.
                </p>
              </div>
            </div>
          </div>
